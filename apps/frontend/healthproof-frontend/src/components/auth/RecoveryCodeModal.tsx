    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/50 px-4 py-6">
      <div className="flex max-h-[85vh] w-full max-w-md flex-col rounded-2xl bg-white shadow-xl">
        ...
        <div className="flex-1 overflow-y-auto px-5 sm:px-6">
          <div className="mb-4 rounded-lg border-2 border-dashed border-gray-300 bg-gray-50 p-3 sm:p-4">
        ...
        <div className="flex flex-col gap-2 p-5 pt-2 sm:flex-row sm:p-6 sm:pt-2">
          <button
            onClick={handleCopy}
